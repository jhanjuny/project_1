...
col_sliced_1=float(input('what value you want to set kx-1 slice value [Å^-1]='))
col_sliced_2=float(input('what value you want to set kx-2 slice value [Å^-1]='))
layer_sliced_1=float(input('what vlaue you want to set ky-1 slice value [Å^-1]='))
layer_sliced_2=float(input('what vlaue you want to set ky-2 slice value [Å^-1]='))
...
fig=make_subplots(
    ...
    # subplot_titles=('', f'ky={Y_select:.2f} [Å<sup>-1</sup>]', 'intensity-Eng'
    #                 , f'Eng={energy_select:.2f} [eV]', f'kx={X_select:.2f} [Å<sup>-1</sup>]')
)
...
#====axis labling====
fig.update_layout(
    title=f'[{name}]<br> 3D modle-cut By JeonJongIn <br> Subplot info: k<sub>x</sub>={X_select:.2f}[Å<sup>-1</sup>]   k<sub>y</sub>={Y_select:.2f}[Å<sup>-1</sup>]   Eng={energy_select:.2f}[eV]',
    scene=dict(
        xaxis_title=r'kx [Å<sup>-1</sup>]',
        yaxis_title=r'ky [Å<sup>-1</sup>]',
        zaxis_title='E [eV]'
    ),       
    margin=dict(l=0, r=0, b=0, t=120),
    xaxis_title='kx [Å<sup>-1</sup>]',
    yaxis_title='Energy [eV]',
    xaxis2_title='Eng [eV]',
    yaxis2_title='Intensity',
    xaxis3_title='kx [Å<sup>-1</sup>]',
    yaxis3_title='ky [Å<sup>-1</sup>]',
    xaxis4_title='Energy [eV]',
    yaxis4_title='ky [Å<sup>-1</sup>]',
)
