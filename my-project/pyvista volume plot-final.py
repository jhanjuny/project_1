...
for i, cmap in enumerate(cmaps):
    pl.add_radio_button_widget(
        update_cmap(cmap),         # 콜백 함수
        radio_button_group='cmap', # 모두 같은 그룹에 포함
        value=(i==4),              # 첫 번째 버튼만 on
...
#=== show & hide arrow ===
current_normal = '-x' # 초기 normal 방향 (x축)
